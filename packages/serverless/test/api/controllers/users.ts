import { HttpContextMock, FunctionRequestMock } from "@example/azura/mocks";
import { User } from "@example/postgres";
import { UserMock } from "@example/postgres/mocks";
import { expect } from "chai";
import { Chance } from "chance";

import * as controller from "../../../src/api/controllers/users";

const chance = new Chance();

describe("api/controllers/users.ts", function() {
  let user: User;
