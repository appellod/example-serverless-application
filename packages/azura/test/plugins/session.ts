...
import { FunctionRequest, HttpContext, MiddlewareLayer, session } from "../../src";
import { FunctionRequestMock, HttpContextMock, SessionStoreMock } from "../../src/mocks";

const chance = new Chance();
const noop = async () => {};

describe("plugins/session.ts", function() {
